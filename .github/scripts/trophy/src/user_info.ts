...
export class UserInfo {
  ...
  constructor(
    ...
    // GitHub's GraphQL API can return null for fields the token lacks scope
    // for (e.g. organizations), and null entries inside repositories.nodes
    // for repos it can't fully resolve. Guard against both instead of
